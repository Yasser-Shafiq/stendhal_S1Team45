...
public class MeetZynn extends AbstractQuest {
	...
	private void step_1() {
		...
		npc.add(ConversationStates.ATTENDING, "history",null,
		...
		npc.add(ConversationStates.ATTENDING, "news",null,
				ConversationStates.ATTENDING,
		...
		npc.add(ConversationStates.ATTENDING, "geography",null,
				ConversationStates.ATTENDING,
		...
		npc.add(ConversationStates.ATTENDING, "places",null,
				ConversationStates.ATTENDING,
		...
		npc.add(ConversationStates.ATTENDING, "Faiumoni",null,
				ConversationStates.ATTENDING,
		...
		npc.add(ConversationStates.ATTENDING, "Or'ril",null,
				ConversationStates.ATTENDING,
		...
		npc.add(ConversationStates.ATTENDING, "Nalwor",null,
				ConversationStates.ATTENDING,
		...
		npc.add(ConversationStates.ATTENDING, "Deniran",null,
				ConversationStates.ATTENDING,
		...
		npc.add(ConversationStates.ATTENDING, "levels",null,
				ConversationStates.ATTENDING,
		...
		npc.add(ConversationStates.ATTENDING, "naming",null,
				ConversationStates.ATTENDING,
		...
		npc.add(ConversationStates.ATTENDING, "positioning",null,
				ConversationStates.ATTENDING,
		...
		npc.add(ConversationStates.ATTENDING, "get",null,
				ConversationStates.ATTENDING,
		...
		npc.add(ConversationStates.ATTENDING, "SPS",null,
				ConversationStates.ATTENDING,
				...
				new IncreaseXPAction(5));
		npc.add(ConversationStates.ATTENDING, "Io",null,
				ConversationStates.ATTENDING,
